 ...
 * Description: Given J jobs and W workers (J <= W), computes the minimum cost
    ...
    * T must be a type large enough to represent integers on the order of J * max(abs(C))
    * C is a matrix of dimensions JxW such that C[j][w] = cost to assign j-th
    ...
    * Time: O(J^2W)
 * Status: https://codeforces.com/contest/164/problem/C
